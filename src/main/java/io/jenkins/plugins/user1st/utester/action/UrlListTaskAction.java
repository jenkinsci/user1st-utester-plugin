...
public class UrlListTaskAction implements Action {

	private Run<?, ?> build;

	private String taskID;

	private UrlListResult results;

	public UrlListTaskAction(Run<?, ?> build) {
		this.build = build;
		this.taskID = "";
		this.results = new UrlListResult();
	}

	public UrlListTaskAction(Run<?, ?> build, String taskID) {
		this.build = build;
		this.taskID = taskID;
		this.results = new UrlListResult();
	}

	public UrlListTaskAction(Run<?, ?> build, String taskID, UrlListResult results) {
		this.build = build;
		this.taskID = taskID;
	...
	public String getDisplayName() {
		return "uTester URL List Task Results";
	}

	@Override
	public String getUrlName() {
		return "uTesterUrlListTask";
	}
	...
	public UrlListResult getResults() {
		return results;
	}

	public void setResults(UrlListResult results) {
		this.results = results;
	}
	...
	private UrlListResult getTaskResults(String taskID) throws JsonParseException, JsonMappingException, IOException {
